...
while answer!= "q":
    try:
        ...
        char_stat+ input("What statistic do you want to know about? (Strength, Speed, or intellegence) ")

        print(f"{char_name.capitalize()}'s {char_stat} is: {hero[char_name][char_stat].capitalize()}")
    except:
        print("You provided incorrect input.")

    answer= input("Press ENTER to choose another hero, or push Q to quit")
